...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 6:
        print(
            "Usage: python ftd_api_scripts/pppoe_static.py host port user passwd ip_addr [intf_hw_name, vpdn_grp_name, pppoe_user, pppoe_password, ppp_auth_type, pppoe_metric, obtain_default_route]")
        exit(1)
